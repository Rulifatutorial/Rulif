...
sourceUrl: `https://www.instagram.com/prettyluvv.caa_`,
mediaUrl: `https://www.instagram.com/prettyluvv.caa_`
}
},
text: teks
}, {
...
││✑${prefix}asupanmenu
└─────────────────┈ ✈
 │𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝘽𝙮 : _@cacaaloaf_
 │𝘼𝙥𝙥𝙡𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝘽𝙮 : _@cacaalvv_
 └─────────────────┈ ✈`
//Button Menu
let freesex = {
viewOnceMessage: {
...
//=================================================//
case 'sc': case 'script': {
m.reply(`Sc Ini Dibuat Oleh Cacaaloaf.
